import folium
from CityDataAfrica import cities, breitengrad, laengengrad
...
def create_map(sus, inf, rec):
    m = folium.Map(location=[-1.2921, 36.8219], zoom_start=6)  # Nairobi, Kenia zentriert
    ...
    # Karte speichern
    m.save('map_SIR_Africa.html')  # Name der HTML-Datei
