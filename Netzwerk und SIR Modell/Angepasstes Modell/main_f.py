...
from Europakarte_f import create_map
import numpy as np
...
for i in range(60):
    ...
    infectODEsolverAll(sus_list, inf_list, rec_list, des_list, exp_list)    #wir lösen die DGL in allen Städten mit der gewünschten Methode
    #infectRK4All(sus_list, inf_list, rec_list, exp_list, des_list)
    #infectEulerAll(sus_list, inf_list, rec_list, exp_list, des_list)
    print('Tag:', i+1)

#Erstelle Karte mit Daten nach geüwnschtem Zeitraum
create_map(all_suspects, all_infections, all_recovered, all_deceased, all_exposed)
